"""Launch FinnAI SLM QLoRA on an On-Demand G instance in us-east-2.

SageMaker GPU training quotas are 0 in Ohio. EC2 On-Demand G/VT is 16 vCPU,
which fits g5.2xlarge (8 vCPU, 1x A10G).
"""
...
DATA_PREFIX = "datasets/finai-slm/v1"
...
aws s3 cp "s3://$BUCKET/code/finai-slm/sourcedir.tar.gz" /tmp/src.tgz --region ap-south-1
